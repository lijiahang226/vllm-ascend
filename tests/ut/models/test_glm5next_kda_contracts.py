...
def test_recurrent_raw_gates_rollback_slots_and_padding(monkeypatch, accepted):
    ...
    out = kda.recurrent_kda(
        q, q, q, gate, beta, state, starts, slots, torch.zeros(1), torch.zeros(128), -4, accepted_tensor
    )
