...
class Glm5NextMoE(nn.Module):
    ...
    def forward(
        ...
        # The gate is owned by the MoE runner, which computes routing scores
        # from hidden states after preparing its communication inputs.
...
class Glm5NextForConditionalGeneration(Glm4vForConditionalGeneration, HasInnerState, IsHybrid):
    ...
    hf_to_vllm_mapper = Glm4vForConditionalGeneration.hf_to_vllm_mapper | GLM5_WEIGHTS_MAPPER
    packed_modules_mapping = GLM5_PACKED_MODULES_MAPPING
