...
class NPUModelRunner(GPUModelRunner):
    ...
    def _sync_metadata_across_dp(
        ...
        # Use NPU all_reduce when VLLM_ASCEND_DP_ALLREDUCE_ON_NPU=1
        # to avoid dirty data in CPU communication on certain devices.
        device_str, group = (
            ("npu", get_dp_group().device_group)
            if ascend_envs.VLLM_ASCEND_DP_ALLREDUCE_ON_NPU
